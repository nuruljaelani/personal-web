                ...
                <div className="container mx-auto px-8 md:px-20 lg:px-28">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 mt-10 md:mt-12 lg:mt-20">
                        <div className="bg-white shadow-lg flex items-center p-2 md:p-4 lg:p-6">
                            <StaticImage src="../images/javascript.svg" width={60} height={60} className="rounded-full" />
                        ...
                        <div className="bg-white shadow-lg flex items-center p-4 lg:p-6">
                            <StaticImage src="../images/nodejs-icon.svg" width={60} height={60} className="rounded-full" />
                            <div className="flex flex-col ml-4 lg:ml-6">
                        ...
                        <div className="bg-white shadow-lg flex items-center p-2 md:p-4 lg:p-6">
                            <StaticImage src="../images/react.svg" width={60} height={60} className="rounded-full" />
                            <div className="flex flex-col ml-4 lg:ml-6">
                        ...
                        <div className="bg-white shadow-lg flex items-center p-2 md:p-4 lg:p-6">
                            <StaticImage src="../images/php.svg" width={60} height={60} className="rounded-full" />
                            <div className="flex flex-col ml-4 lg:ml-6">
                        ...
                        <div className="bg-white shadow-lg flex items-center p-2 md:p-4 lg:p-6">
                            <StaticImage src="../images/laravel.svg" width={60} height={60} className="rounded-full" />
                            <div className="flex flex-col ml-4 lg:ml-6">
                        ...
                        <div className="bg-white shadow-lg flex items-center p-2 md:p-4 lg:p-6">
                            <StaticImage src="../images/figma.svg" width={60} height={60} className="rounded-full" />
                            <div className="flex flex-col ml-4 lg:ml-6">
